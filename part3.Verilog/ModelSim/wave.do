...
add wave -noupdate -label r4 -radix hexadecimal /testbench/U1/r4
add wave -noupdate -label r5 -radix hexadecimal /testbench/U1/r5
add wave -noupdate -label r6 -radix hexadecimal /testbench/U1/r6
